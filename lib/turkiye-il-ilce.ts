 ...
 * Kaynak: Türkiye İstatistik Kurumu (TÜİK) idari birim listesi.
 * 2012 Büyükşehir Kanunu (6360) sonrası güncel yapıya göre düzenlenmiştir.
 * İller ve ilçeler Türkçe alfabetik sırayla dizilmiştir.
 */
...
export const IL_ILCE: Record<string, string[]> = {
  ...
  Burdur: [
    'Ağlasun', 'Altınyayla', 'Bucak', 'Çavdır', 'Çeltikçi', 'Gölhisar', 'Kemer',
  ...
  Çankırı: [
    'Atkaracalar', 'Bayramören', 'Çerkeş', 'Eldivan', 'Ilgaz', 'Korgun',
  ...
  Kütahya: [
    ...
    'Hisarcık', 'Merkez', 'Pazarlar', 'Simav', 'Şaphane', 'Tavşanlı',
  ],
  Malatya: [
  ...
  Samsun: [
    ...
    'İlkadım', 'Kavak', 'Ladik', 'Ondokuzmayıs', 'Salıpazarı', 'Tekkeköy', 'Terme',
    'Vezirköprü', 'Yakakent',
  ],
  Siirt: [
...
/** Alfabetik sıralı il listesi (Türkçe sıralama) */
